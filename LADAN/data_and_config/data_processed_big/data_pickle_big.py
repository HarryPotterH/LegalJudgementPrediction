...
for i in range(len(file_list)):
    ...
    term_lists = []
    num = 0
    with open('../big_data/{}_cs.json'.format(file_list[i]), 'r', encoding='utf-8') as f:
        idx = 0
    ...
    pk.dump(data_dict, open('../data_processed_big/{}_processed_thulac_large.pkl'.format(file_list[i]), 'wb'))
    print(num)
